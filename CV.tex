...
\address{\hspace{-1in}19 Twin Circle Drive}{Westport, CT}    % optional, remove the line if not wanted
...
\cventry{2009--2011}{Research Experience}{MesoMaterials Laboratory}{Drexel University}{}{Focused research on application of Atomic Layer Deposition to ferroelectric oxide thin films. \newline{}%
Co-Op Experiences were 6 month periods (Spring/Summer) of full time employment. \newline{}%
Student Research was performed during periods when simultaneously attending courses. 
\begin{multicols}{2}
...
\cventry{Summer 2008}{STAR: Summer Research Experience}{MesoMaterials Laboratory}{Drexel University}{}{Ten week period spent learning to organize and develop a personal research project. 
 \begin{itemize}%
  \item Learned statistics-based design of experiments;
...
\cventry{\textbf{Thin Film Deposition}}{\textmd{Atomic Layer Deposition (ALD)}}{\textup{Chemical Vapor Deposition (CVD), Pulsed Laser Deposition (PLD), \mbox{Molecular} Beam Epitaxy (MBE)}}{}{}{}\vspace{0.5em}
...
\cventry{\textbf{Chemical \& Thermal Analysis}}{\textmd{Fourier-Transform Infrared Spectroscopy (FTIR)}}{\textup{Differential Scanning Calorimetry (DSC),   
...
\cvitem{Electronics}{\small Design and synthesis of novel materials for IC applications, particularly those leveraging unique quantum effects} 
